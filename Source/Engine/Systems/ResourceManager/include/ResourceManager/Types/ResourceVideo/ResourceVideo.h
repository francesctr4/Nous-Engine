...
{
public:
    NOUS_ENGINE_API explicit ResourceVideo(uint32_t uid = 0);
    ...
    NOUS_ENGINE_API void SetWidth(uint32_t _width);
    NOUS_ENGINE_API void SetHeight(uint32_t _height);
    ...
    [[nodiscard]] NOUS_ENGINE_API uint32_t          GetWidth() const;
    [[nodiscard]] NOUS_ENGINE_API uint32_t          GetHeight() const;
