...
TEST_F(t_ComponentList, ForEachType_VisitsEveryDeclaredType)
{
    ...
    // CTransform, CMesh, CMaterial, CCamera, CLight, CScript, CPrefab, CPrefabLink,
    // CAudioSource, CAudioListener, CVideoPlayer, CAnimator, CBoneAttachment.
    //
